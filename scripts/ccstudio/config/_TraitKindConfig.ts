...
@ccclass
export default class _TraitKindConfig extends _BaseParse {
    private static _instance: _TraitKindConfig = null;
    jsonName = "traitKind";
    get(e: any) {
        return this.cfg[e];
    }
    random() {
        ...
        return Utils_.getItemByWeight(t, (t) => {
            return this.get(t).rate;
        });
    }
    static get Instance() {
        return this._instance || (this._instance = new _TraitKindConfig());
    }
}
