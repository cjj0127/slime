...
@ccclass
export default class _SkillLevelConfig extends _BaseParse {
    private static _instance: _SkillLevelConfig = null;
    jsonName = "skillLevel";
    public get(e: any, t: any): any {
        return p.get(this.cfg, [e, t]);
    }
    public getMaxLevel(e: any): number {
        return Object.keys(p.get(this.cfg, e)).length;
    }
    public loaded(): void {
        p.each(this.cfg, (e) => {
            p.each(e, (e) => {
    ...
    public static get Instance(): _SkillLevelConfig {
        if (_SkillLevelConfig._instance == null) {
            _SkillLevelConfig._instance = new _SkillLevelConfig();
        }
        return _SkillLevelConfig._instance;
    }
}
